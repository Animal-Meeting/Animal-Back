...
docker-compose -f docker-compose.minipc.yml build >> $DEPLOY_LOG 2>&1
...
docker-compose -f docker-compose.minipc.yml down >> $DEPLOY_LOG 2>&1
...
docker-compose -f docker-compose.minipc.yml up -d >> $DEPLOY_LOG 2>&1
